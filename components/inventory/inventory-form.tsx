...
const formSchema = z.object({
  ...
  laboratory: z.string().min(2, "El laboratorio debe tener al menos 2 caracteres"),
...
export function InventoryForm({ onSubmit, initialData, trigger, title = "Agregar Nuevo Producto" }: InventoryFormProps) {
